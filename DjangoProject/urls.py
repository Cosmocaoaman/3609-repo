...
urlpatterns = [
    # Django admin interface (for developers only)
    path('admin/', admin.site.urls),
    
    # RESTful API endpoints
    path('api/', include('api.urls')),
    
    # Custom admin panel removed; admin features will be via API + React
]

# Custom error handlers (must be defined in root URLs)
